...
Multiplayer card game and cash-table app ecosystem.

## What FREEOS should store here

Keep approved project knowledge, working notes, references, and user-provided artifacts related to ReemTeam.
